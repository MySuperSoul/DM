...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; According to the results, we can see that feature GPA's Gain is higher than gender, so the root of decision tree we will use the GPA, the second layer is gender, so the decision tree is drawn below:
...
- largest SD:
![](../answer_images/hw3_4_1_max.png)

- smallest SD:
![](../answer_images/hw3_4_1_min.png)

<br>

**(b)**
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We can run kmeans algorithm for many times and then select the best result or the most occurance result from all the result data, the result may be more stable than just one time kmeans algorithm run.

<br>

**(c)**
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;After running the process code, I get the result plots below, you can also find it in `show_kmenas_digits.m`:
- k = 10:
...
- k = 8:
![](../answer_images/hw3_4_4_k_8.png)
- k = 16:
![](../answer_images/hw3_4_4_k_16.png)
- k = 32:
![](../answer_images/hw3_4_4_k_32.png)
- k = 64:
![](../answer_images/hw3_4_4_k_64.png)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;As for the compressing ratio:
$$
ratio = \frac{\log K}{3 * 8} = \frac{\log K}{24} = \frac{\log64}{24} = \frac{6}{24} = 0.25
$$
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;So the compressing ratio when `K = 64` is 25%.